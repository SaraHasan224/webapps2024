    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_status', models.CharField(choices=[('1', 'Paid'), ('2', 'Rejected'), ('0', 'Not paid')], default='0', max_length=1)),
                ('action', models.CharField(choices=[('0', 'Void'), ('1', 'Credit'), ('2', 'Debit')], default='0', max_length=1)),
                ('status', models.CharField(choices=[('0', 'Draft'), ('1', 'Sent'), ('2', 'Processing'), ('3', 'Processed'), ('4', 'Rejected')], default='0', max_length=1)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_read', models.CharField(choices=[('1', 'Read'), ('0', 'Unread')], default='0', max_length=1)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('invoice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='n_invoice', to='payapp.invoice')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', 'Paid'), ('0', 'Not paid'), ('2', 'Rejected')], default='0', max_length=1)),
